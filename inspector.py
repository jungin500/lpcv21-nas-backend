...
def get_model_metrics(model: torch.nn.Module, input_size=(1, 3, 224, 224)):
    ...
    model_statistics = summary(model, input_size, verbose=0)
    ...
    return params_mega, input_size_mb, param_size_mb, memory_mb, madds, flops_mega, memrw_mb
...
if __name__ == '__main__':
    ...
    print(get_model_metrics(prepared_ssd_model, (1, 3, 300, 300)))